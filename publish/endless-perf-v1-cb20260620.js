...
function patchHud(){let old=window.updateHud;if(typeof old!=='function')return;window.updateHud=function(){old();if(!endless())return;let job=document.getElementById('job');if(job)job.textContent+=` · 怪${adds()}/${cap()||100}`}}
