...
window.GameModules.equipment = (() => {
  ...
  const SET_BONUS = {
    'aureate-guardian':{n:'辉金守护',s:'2件 生命+28%、神圣抗性+22%；4件 护甲+14%、回复+12%；6件 大蒜光环伤害+300%~500%（独立乘区）。',b2:{hp:.28,holy:.22},b4:{armor:.14,regen:.12},b6:{skill:'garlic',skillDmg:4,range:.24,shieldAttrBlock:.32}},
    'thorn-bulwark':{n:'荆棘壁垒',s:'2件 护甲+22%、物理抗性+24%；4件 生命+24%；6件 血色新星伤害+300%~500%（独立乘区）。',b2:{armor:.22,physical:.24},b4:{hp:.24},b6:{skill:'bloodNova',skillDmg:4,bossAttrCut:.12}},
    'dawn-judgment':{n:'黎明审判',s:'2件 伤害+24%、范围+16%；4件 神圣伤害+24%；6件 圣光长枪伤害+330%~550%（独立乘区）。',b2:{damage:.24,range:.16},b4:{holy:.24},b6:{skill:'holyLance',skillDmg:4.5,eliteAttrCut:.12}},
    'astral-missile':{n:'星界飞弹',s:'2件 奥术伤害+24%、冷却+14%；4件 伤害+20%；6件 魔法飞弹伤害+330%~550%（独立乘区）。',b2:{arcane:.24,cooldown:.14},b4:{damage:.2},b6:{skill:'missile',skillDmg:4.5,range:.14}},
    'ember-meteor':{n:'余烬陨星',s:'2件 火焰伤害+28%、范围+16%；4件 伤害+22%；6件 陨星伤害+350%~575%（独立乘区）。',b2:{fire:.28,range:.16},b4:{damage:.22},b6:{skill:'meteorShard',skillDmg:4.6,bossAttrCut:.1}},
    'storm-sigil':{n:'风暴符印',s:'2件 攻速+22%、奥术抗性+18%；4件 冷却+18%；6件 雷链伤害+300%~500%（独立乘区）。',b2:{atkSpeed:.22,arcane:.18},b4:{cooldown:.18},b6:{skill:'thunderChain',skillDmg:4,range:.12}},
    'cyclone-axe':{n:'旋风飞斧',s:'2件 物理伤害+24%、攻速+18%；4件 范围+18%；6件 飞斧伤害+330%~550%（独立乘区）。',b2:{physical:.24,atkSpeed:.18},b4:{range:.18},b6:{skill:'axe',skillDmg:4.5,move:.12}},
    'moon-hunter':{n:'月影猎手',s:'2件 移速+18%、暴击+16%；4件 霜寒伤害+22%；6件 月牙斩伤害+330%~550%（独立乘区）。',b2:{move:.18,crit:.16},b4:{frost:.22},b6:{skill:'moonSlash',skillDmg:4.5,damage:.14}},
    'venom-shadow':{n:'毒影伏击',s:'2件 暗影伤害+24%、移速+14%；4件 攻速+18%；6件 毒雾伤害+300%~500%（独立乘区）。',b2:{shadow:.24,move:.14},b4:{atkSpeed:.18},b6:{skill:'poisonCloud',skillDmg:4,eliteAttrCut:.12}},
    'crimson-vessel':{n:'绯红圣器',s:'2件 生命+30%、欲望抗性+22%；4件 回复+18%；6件 欲液反涌伤害+330%~550%（独立乘区）。',b2:{hp:.3,lust:.22},b4:{regen:.18},b6:{skill:'lustSplash',skillDmg:4.5,shieldAttrBlock:.28}},
    'violet-hymn':{n:'紫罗兰圣歌',s:'2件 范围+20%、神圣/欲望抗性+16%；4件 回复+14%；6件 献媚祈祷伤害+300%~500%（独立乘区）。',b2:{range:.2,holy:.16,lust:.16},b4:{regen:.14},b6:{skill:'lustPrayer',skillDmg:4,attrCapBonus:.08}},
    'rose-mirror':{n:'蔷薇镜像',s:'2件 伤害+22%、暗影/欲望抗性+18%；4件 暴击+16%；6件 飞吻伤害+300%~500%（独立乘区）。',b2:{damage:.22,shadow:.18,lust:.18},b4:{crit:.16},b6:{skill:'lustKiss',skillDmg:4,range:.14}},
    'reaper-waltz':{n:'冥月圆舞',s:'2件 移速+18%、物理/暗影抗性+16%；4件 伤害+22%；6件 残月镰舞伤害+330%~550%（独立乘区）。',b2:{move:.18,physical:.16,shadow:.16},b4:{damage:.22},b6:{skill:'scytheArc',skillDmg:4.5,move:.14,shieldAttrBlock:.24}},
    'blood-reaping':{n:'血镰誓约',s:'2件 生命+28%、回复+14%；4件 护甲+12%；6件 血镰回旋伤害+300%~500%（独立乘区）。',b2:{hp:.28,regen:.14},b4:{armor:.12},b6:{skill:'bloodReap',skillDmg:4,bossAttrCut:.1}},
    'soul-shadow':{n:'断魂影镰',s:'2件 暗影伤害+24%、暴击+14%；4件 攻速+18%；6件 幽魂刃舞伤害+330%~550%（独立乘区）。',b2:{shadow:.24,crit:.14},b4:{atkSpeed:.18},b6:{skill:'wraithBlade',skillDmg:4.5,eliteAttrCut:.12}},
  };
  const PALADIN_RECTS = (() => {
